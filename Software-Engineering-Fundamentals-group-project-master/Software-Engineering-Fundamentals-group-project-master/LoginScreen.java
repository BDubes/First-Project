...
public class LoginScreen extends JPanel {
  ...
  private final JPanel labelPanel1 = new JPanel();
  private final JPanel labelPanel2 = new JPanel();
  ...
  public LoginScreen(MainFrame mainFrame) {
    ...
    labelPanel1.add(usernameLabel);
    usernamePanel.add(labelPanel1);
